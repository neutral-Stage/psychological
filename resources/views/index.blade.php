...
@section('content')
	...
	<div class="hero-wrap" style="background-image: url('front/images/bg_1.jpg'); background-attachment:fixed;">
    ...
    <section class="ftco-section-2 img" style="background-image: url(front/images/bg_3.jpg);">
    	<div class="container">
    ...
    <section class="ftco-section">
        ...
        <div class="row">
        	<div class="col-md-6 col-lg-3 ftco-animate">
	          <div class="block-2">
	            <div class="flipper">
	              <div class="front" style="background-image: url(front/images/doctor-1.jpg);">
	                <div class="box">
	                  <h2>Aldin Powell</h2>
	                  <p>Neurologist</p>
	                </div>
	              ...
	              <div class="back">
	                ...
	                <div class="author d-flex">
	                  <div class="image mr-3 align-self-center">
	                    <div class="img" style="background-image: url(front/images/doctor-1.jpg);"></div>
	                  </div>
	        ...
	        <div class="col-md-6 col-lg-3 ftco-animate">
	          <div class="block-2">
	            <div class="flipper">
	              <div class="front" style="background-image: url(front/images/doctor-2.jpg);">
	                <div class="box">
	                  <h2>Aldin Powell</h2>
	                  <p>Pediatrician</p>
	                </div>
	              ...
	              <div class="back">
	                ...
	                <div class="author d-flex">
	                  <div class="image mr-3 align-self-center">
	                    <div class="img" style="background-image: url(front/images/doctor-2.jpg);"></div>
	                  </div>
	        ...
	        <div class="col-md-6 col-lg-3 ftco-animate">
	          <div class="block-2">
	            <div class="flipper">
	              <div class="front" style="background-image: url(front/images/doctor-3.jpg);">
	                <div class="box">
	                  <h2>Aldin Powell</h2>
	                  <p>Ophthalmologist</p>
	                </div>
	              ...
	              <div class="back">
	                ...
	                <div class="author d-flex">
	                  <div class="image mr-3 align-self-center">
	                    <div class="img" style="background-image: url(front/images/doctor-3.jpg);"></div>
	                  </div>
	        ...
	        <div class="col-md-6 col-lg-3 ftco-animate">
	          <div class="block-2">
	            <div class="flipper">
	              <div class="front" style="background-image: url(front/images/doctor-4.jpg);">
	                <div class="box">
	                  <h2>Aldin Powell</h2>
	                  <p>Pulmonologist</p>
	                </div>
	              ...
	              <div class="back">
	                ...
	                <div class="author d-flex">
	                  <div class="image mr-3 align-self-center">
	                    <div class="img" style="background-image: url(front/images/doctor-4.jpg);"></div>
	                  </div>
    ...
    <section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(front/images/bg_4.jpg);">
    	<div class="container">
    		<div class="row justify-content-center mb-5 pb-3">
